...
IF YOU WANT TO INSTALL THE PACKAGE USING PyPi (pip version) go there : [HOW TO PIP INSTALL tahoma ?](https://github.com/pzim-devdata/tahoma#install-the-main-package-)
