...
IF YOU WANT TO INSTALL THE PACKAGE USING PyPi (pip version) go there : [HOW TO PIP INSTALL ?](https://github.com/pzim-devdata/tahoma/blob/main/README.md?plain=1#L120)
